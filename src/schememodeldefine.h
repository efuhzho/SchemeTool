...
class TestPointName:QString
{

public:
    TestPointName(const QString &str_) : str(str_) {}
...
typedef struct subTpye
{
    ...
    QString id;
    QString type;
    QMap<TestPointName,TestPoint> testPoints;
    ...
    QJsonObject toJson( ) const
    {
        ...
        QMap<TestPointName, TestPoint>::const_iterator iter = testPoints.cbegin( );
